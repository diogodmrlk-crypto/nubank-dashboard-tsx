...
function TransferFlow({ onBack, onClose }: { onBack: () => void; onClose: () => void }) {
  ...
  if (step === 'success') return <div className="pix-screen transfer-overlay success-screen"><div className="success-mark">✓</div><h1>Transferência realizada</h1><p>Você enviou R$ {amount} para {recipient}.</p><button className="pix-primary" onClick={onClose}>Concluir</button></div>
